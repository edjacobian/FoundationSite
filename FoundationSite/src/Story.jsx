    ...
    <div className='story-container'>
        ...
        <div className="mission-text-container">
          ...
          <div className='slideshow'>
            <Slider {...settings}>
              <div>
                <img src={Bob1} className='homephotos' alt="Bob 1"/>
              </div>
              <div>
                <img src={Bob2} className='homephotos' alt="Bob 2" />
              </div>
              <div>
                <img src={Bob3} className='homephotos' alt="Bob 3" />
              </div>
              <div>
                <img src={Bob4} className='homephotos' alt="Bob 4" />
              </div>
              <div>
                <img src={Bob5} className='homephotos' alt="Bob 5" />
              </div>
              <div>
                <img src={Bob6} className='homephotos' alt="Bob 6" />
              </div>
              <div>
                <img src={Bob7} className='homephotos' alt="Bob 7" />
              </div>
              <div>
                <img src={Bob8} className='homephotos' alt="Bob 8" />
              </div>
            </Slider>
          </div>
      </div>
